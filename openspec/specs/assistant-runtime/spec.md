...
Define the long-lived rootless assistant runtime contract, including workspace mounting, containerized shell access, and rebuild behavior that avoids treating container-internal state as durable truth.
